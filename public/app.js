...
(function () {
    ...
    var form = document.querySelector('form'); //HTMLFormElement | null
    var todos = [];
    var users = [];
    // Attach Events
    ...
    function getUserName(userId) {
        var user = users.find(function (u) { return u.id === userId; }); //User | undefined
    ...
    function initApp() {
        Promise.all([getAllTodos(), getAllUsers()]).then(function (values) {
            todos = values[0], users = values[1]; //не всегда есть возможность работать с глобальными переменными
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (error_1 instanceof Error)
                            alertError(error_1);
                        return [2 /*return*/, []]; // в противном случае возвращаем пустой массив
